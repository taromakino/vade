...
def main(config):
    ...
    model = Model(config.input_dim, config.hidden_dims, config.latent_dim, config.n_components, config.lr)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_dims", nargs="+", type=int, default=[256, 256, 384, 512])
